...
public class task_lesson_5{
    ...
    public static void main(String[] args) {
        ...
        /* System.out.println("The numbers divisible by either 3 or 5 but not both are:-");
        for (int i =1; i <= 50; i++){ //assuming both 1 and 50 are inclusive.
            if ((i%3) == 0){
                if ((i%5) == 0){
                    continue;
                } else{
        ...
        System.out.print("Enter a number to print all numbers till it except the multiples of 4: ");
